...
<div class="main-content-cotar">
    <div class="container">
        ...
        <form action="/amil-resultado-editavel" id="cotarForm" name="cotar" method="post">
...
<script>
    ;(function validateForm($) {
        ...
        $('#cotarForm').on('submit', function(e) {
            ...
            if(plano_amil == 1) {
               $('#cotarForm').attr('action', '/amil-resultado-editavel');
               console.log('1');
            } else if(plano_amil == 2) {
                $('#cotarForm').attr('action', '/amil-facil-resultado-editavel');
                console.log('2');
            } else if(plano_amil == 3) {
                $('#cotarForm').attr('action', '/amil-one-resultado-editavel');
                console.log('3');
            }
