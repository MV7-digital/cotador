...
<?php 
    ...
    $dados = $wpdb->get_results("SELECT * FROM wp7d_dados WHERE localidades = '$tabela_regiao' AND tabela = '$tabela' AND coparticipacao = '$cooparticipacao' AND remissao = 'Com remissao' AND categoria = '$tipo_contratacao' AND descricaoDoPlano = '$tipo_plano'");
      ...
      <div class="modal-body">
        <div class="container" id="content">
            <div class="row" id="content-img1">
                ...
                <img src="<?=get_template_directory_uri() . '/img/capa-bradesco.jpg';?>" alt="Página 1">
            </div>
            <div class="row row-tabela" id="content-img2">
                ...
                <div class="col-12 introducao">
                    ...
                    <h2 <?=$qnt_planos < 3 ? 'style="font-size: 84px; max-width: 85%"' : ''; ?>>OPÇÕES DE PLANOS DE SAÚDE <span class="texto-bradesco" <?=$qnt_planos < 3 ? 'style="font-size: 84px!important   ; max-width: 80%"' : ''; ?>>Bradesco</span></h2>
                </div>
                <?php
                    for($i=0;$i<$qnt_planos;$i++){
                    ?>
                            <div class="col-4 bradesco">
                                <div class="row">
                                    <div class="col-4 logo-empresas">
                                        <img src="<?=get_template_directory_uri() . '/img/logo-bradesco-saude-white.png';?>" alt="Logo Bradesco">
                                    </div>
                                    <div class="col-8">
            ...
            <div class="row" id="content-img3">
                <img src="<?=get_template_directory_uri() . '/img/bradesco-rede-credenciada.png';?>" alt="Página 1">
            </div>
            <div class="row" id="content-img4">
                <img src="<?=get_template_directory_uri() . '/img/labs-carencia.png';?>" alt="Página 1">
            </div>
        </div>
      </div>
    ...
    <div class="container">
        ...
        <div class="row row-tabela">
            <?php
                for($i=0;$i<$qnt_planos;$i++){
                ?>
                    <div id="<?="col_" . $i?>" class="col-4 bradesco cotando">
                        <div class="row">
                            <div class="col-4 logo-empresas">
                                <img src="<?=get_template_directory_uri() . '/img/logo-bradesco-saude-white.png';?>" alt="Logo Bradesco">
                            </div>
                            <div class="col-8">
                                ...
                                <label for="Tipo do Plano">
                                    <select  name="tipo_plano_<?=$i?>" id="tipo_plano_<?=$i?>" required>
                                        ...
                                        <option value="TNWE [E]">TNWE [E]</option>
                                        <option value="TNWQ [A]">TNWQ [A]</option>
                                        <option value="FCEX [E]">FCEX [E]</option>
                                        <option value="FCQX [A]">FCQX [A]</option>
                                        <option value="TNI1 [E]">TNI1 [E]</option>
                                        <option value="TNI2 [A]">TNI2 [A]</option>
                                        <option value="TNEE [E]">TNEE [E]</option>
                                        <option value="TNQQ [A]">TNQQ [A]</option>
                                        <option value="TQN2 [A]">TQN2 [A]</option>
                                        <option value="TQN3 [A]">TQN3 [A]</option>
                                        <option value="TNME [E]">TNME [E]</option>
                                        <option value="TNMQ [A]">TNMQ [A]</option>
                                        <option value="TNP4 [A]">TNP4 [A]</option>
                                        <option value="TNP6 [A]">TNP6 [A]</option>
                                        <option value="TNP8 [A]">TNP8 [A]</option>
                                        <option value="TNC6 [A]">TNC6 [A]</option>
                                        <option value="TNC8 [A]">TNC8 [A]</option>
                                        <option value="TNPX [A]">TNPX [A]</option>
                                    </select>
                                </label>
                        ...
                        <div class="row tabela">
                            ...
                            <div class="col-4 text-center">
                                ...
                                ?>
                                <p>R$<input type="text" id="vidas_total_amount_<?=$i . '_' . $j?>" readonly class="vidas_total total_amount" value="0"></p>
                                <?php
                                    }
                                ?>
        ...
        <div class="pb-3">
            <button type="submit" name="previsualizar" id="previsualizar" class="btn btn-primary btn-cotar" data-toggle="modal" data-target="#exampleModal">Pré Visualizar</button>
        </div>
...
;(function($){
    ...
    for(i=0; i < <?=$qnt_planos?>;i++){
        ...
        plano.on('change', function(e) {
            ...
            $.ajax({
                url: '<?=get_template_directory_uri() . "/page-bradesco-plano.php";?>',
                method: 'POST',
                data: {
                    nome: u_nome,
                    telefone: u_telefone,
