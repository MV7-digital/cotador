...
<div class="main-content-cotar">
    <div class="container">
        ...
        <form action="/unimed-resultado-editavel" name="cotarForm" id="cotarForm" method="post">
            <div class="row borda mt-5">
                <div class="col-6 quadro1">
                    <div class="bg-logo unimed">
                        <img src="<?=get_template_directory_uri() . '/img/logo-unimed.png';?>" height="50px" alt="Logo unimed">
                    </div>
                    <h1 class="txt-unimed">ADICIONE NOS CAMPOS AS INFORMAÇÕES PARA A SUA COTAÇÃO.</h1>
                    <div class="dados">
                ...
                <div class="col-6 quadro2 unimed">
                    <div class="dados">
