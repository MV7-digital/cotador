...
<?php 
    ...
    $dados = $wpdb->get_results("SELECT * FROM wp7d_dados_unimed WHERE tabela = '$tabela' AND coparticipacao = '$cooparticipacao' AND localidades = '$tabela_regiao' AND opcional_compulsorio = '$tipo_contratacao' AND descricao_do_plano = '$tipo_plano'");
      ...
      <div class="modal-body">
        <div class="container" id="content">
            <div class="row" id="content-img1">
                ...
                <img src="<?=get_template_directory_uri() . '/img/capa-CNU.jpg';?>" alt="Página 1">
            </div>
            <div class="row row-tabela" id="content-img2">
                <div class="col-12 introducao introducao-unimed">
                ...
                <?php
                    ...
                    ?>
                            <div class="col-4 bradesco unimed">
                                <div class="row">
                                    <div class="col-4 logo-empresas">
                                    <img src="<?=get_template_directory_uri() . '/img/logo-unimed.png';?>" alt="Logo unimed">
                                    </div>
                                    <div class="col-8">
                                ...
                                <div class="row tabela txt-unimed">
                                    <div class="col-3 text-center">
                                        <p>0 - 18 anos</p>
                                        <p>19 - 23 anos</p>
                                        <p>24 - 28 anos</p>
                ...
                ?>
                <div class="valores">
                    <div class="sem-iof unimed">
                        <p>TOTAL SEM IOF: R$ <span id="sem-iof">0</span></p>
                    </div>
                    <div class="iof unimed">
                        <p>TOTAL COM IOF: R$ <span id="com-iof">0</span></p>
                    </div>
                </div>
            </div>
            <div class="row" id="content-img3">
                <img src="<?=get_template_directory_uri() . '/img/cnu-rede-credenciada.png';?>" alt="Página 1">
            </div>
            <div class="row" id="content-img4">
                <img src="<?=get_template_directory_uri() . '/img/cnu-rede-credenciada-02.png';?>" alt="Página 1">
            </div>
            <div class="row" id="content-img5">
                <img src="<?=get_template_directory_uri() . '/img/rede-laboratorios-cnu.png';?>" alt="Página 1">
            </div>
        </div>
      </div>
    ...
    <div class="container">
        ...
        <div class="row row-tabela">
            <?php
                for($i=0;$i<$qnt_planos;$i++){
                ?>
                    <div class="col-4 bradesco unimed cotando">
                        <div class="row">
                            <div class="col-4 logo-empresas">
                                <img src="<?=get_template_directory_uri() . '/img/logo-unimed.png';?>" alt="Logo unimed">
                            </div>
                            ...
                            <h2>PLANO DE SAÚDE:</h2>
                                <label for="Tipo do Plano">
                                    <select  name="tipo_plano_<?=$i?>" id="tipo_plano_<?=$i?>" required>
                                        ...
                                        <option value="Clássico [E]">Clássico [E]</option>
                                        <option value="Estilo [E]">Estilo [E]</option>
                                        <option value="Estilo [A]">Estilo [A]</option>
                                        <option value="Absoluto [A]">Absoluto [A]</option>
                                        <option value="Superior [A]">Superior [A]</option>
                                        <option value="Exclusivo [A]">Exclusivo [A]</option>
                                        <option value="Bem Estar [E]">Bem Estar [E]</option>
                                        <option value="Bem Estar [A]">Bem Estar [A]</option>
                                    </select>
                                </label>
                        ...
                        <div class="row tabela txt-unimed">
                            ...
                            <div class="col-4 text-center">
                                ...
                                ?>
                                <p>R$<input type="text" id="vidas_total_amount_<?=$i . '_' . $j?>" readonly class="vidas_total txt-unimed total_amount" value="<?=$values[$j]?>"></p>
                                <?php
                                    }
                                ?>
        ...
        <div class="pb-3">
            <button type="submit" name="previsualizar" id="previsualizar" class="btn btn-primary btn-cotar unimed" data-toggle="modal" data-target="#exampleModal">Pré Visualizar</button>
        </div>
...
for(i=0; i < <?=$qnt_planos?>;i++){
    ...
    plano.on('change', function(e) {
        ...
        console.log(u_cooparticipacao, u_tipo_contratacao, u_tipo_plano, u_tabela_regiao, u_qtd_vidas, u_tabela);

        $.ajax({
            url: '<?=get_template_directory_uri() . "/page-seguros_unimed-plano.php";?>',
            method: 'POST',
            data: {
                nome: u_nome,
                telefone: u_telefone,
