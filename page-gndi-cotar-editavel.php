...
<div class="main-content-cotar">
    <div class="container">
        ...
        <form action="/gndi-resultado-editavel" name="cotarForm" id="cotarForm" method="post">
            <div class="row borda mt-5">
                <div class="col-6 quadro1">
                    <div class="bg-logo gndi">
                        <img src="<?=get_template_directory_uri() . '/img/logo-gndi-white.png';?>" height="50px" alt="Logo GNDI">
                    </div>
                    <h1 class="txt-gndi">ADICIONE NOS CAMPOS AS INFORMAÇÕES PARA A SUA COTAÇÃO.</h1>
                    <div class="dados">
