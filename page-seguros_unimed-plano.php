...
$query = "SELECT * FROM wp7d_dados_seguros_unimed WHERE tabela = '$tabela' AND coparticipacao = '$cooparticipacao' AND localidades = '$tabela_regiao' AND opcional_compulsorio = '$tipo_contratacao' AND descricao_do_plano = '$tipo_plano'";
