...
header('Content-Type: application/json');
    ...
    $query = "SELECT * FROM wp7d_dados_sulamerica WHERE tipo = '$tipo' AND atendimento = '$atendimento' AND coparticipacao = '$cooparticipacao' AND remissao = 'Com remissao' AND localidades = '$tabela_regiao' AND categoria = '$tipo_contratacao' AND descricao_do_plano = '$tipo_plano'";
