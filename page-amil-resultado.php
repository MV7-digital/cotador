      ...
      <div class="modal-body">
        <div class="container" id="content">
            ...
            <div class="row row-tabela" id="content-img2">
                ...
                <div class="col-12 introducao introducao-amil">
                    <span>VALORES | REEMBOLSOS | CARÊNCIAS</span>
                    <h2 <?=$qnt_planos < 3 ? 'style="font-size: 84px; max-width: 85%;  line-height: 100%"' : ''; ?>>OPÇÕES DE PLANOS DE SAÚDE <span class="txt-amil" <?=$qnt_planos < 3 ? 'style="font-size: 84px!important; max-width: 80%; line-height: 100%"' : 'style="font-size: 48px"'; ?>>Amil</span></h2>
                </div>
                <?php
                    for($i=0;$i<$qnt_planos;$i++){
                    ?>
                            <div class="col-4 bradesco amil">
                                <div class="row">
            ...
            <div class="row" id="content-img2">
                <img src="<?=get_template_directory_uri() . '/img/novo-modelo-de-rede-amil-S.png';?>" alt="Página 1">
            </div>
            <div class="row" id="content-img3">
                <img src="<?=get_template_directory_uri() . '/img/novo-modelo-de-rede-amil-s-2.jpg';?>" alt="Página 1">
            </div>
            <div class="row" id="content-img6">
                <img src="<?=get_template_directory_uri() . '/img/rede-laboratorios-amil-s-one.png';?>" alt="Página 1">
            </div>
        </div>
      </div>
    ...
    <div class="container">
        ...
        <div class="row row-tabela">
            <?php
                for($i=0;$i<$qnt_planos;$i++){
                ?>
                    <div class="col-4 bradesco amil cotando">
                        <div class="row">
                            <div class="col-4 logo-empresas">
                                <img src="<?=get_template_directory_uri() . '/img/logo-amil-branco.webp';?>" alt="Logo Amil">
                            </div>
                            ...
                            <h2>PLANO DE SAÚDE:</h2>
                                <label for="Tipo do Plano">
                                    <select  name="tipo_plano_<?=$i?>" id="tipo_plano_<?=$i?>" required>
                                        ...
                                        <option value="S380 [E]">S380 [E]</option>
                                        <option value="S380 [A]">S380 [A]</option>
                                        <option value="S450 [E]">S450 [E]</option>
                                        <option value="S450 [A]">S450 [A]</option>
                                        <option value="S580 [A]">S580 [A]</option>
                                        <option value="S750 R1 [A]">S750 R1 [A]</option>
                                        <option value="S750 R2 [A]">S750 R2 [A]</option>
                                    </select>
                                </label>
                        ...
                        <div class="row tabela txt-amil">
                            ...
                            <div class="col-4 text-center">
                                ...
                                ?>
                                <p>R$<input type="text" id="vidas_total_amount_<?=$i . '_' . $j?>" readonly class="vidas_total txt-amil total_amount" value="<?=$values[$j]?>"></p>
                                <?php
                                    }
                                ?>
        ...
        <div class="pb-3">
            <button type="submit" name="previsualizar" id="previsualizar" class="btn btn-primary btn-cotar amil" data-toggle="modal" data-target="#exampleModal">Pré Visualizar</button>
        </div>
