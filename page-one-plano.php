...
$query = "SELECT * FROM wp7d_dados_amil WHERE tabela = '$tabela' AND coparticipacao = '$cooparticipacao' AND localidades = '$tabela_regiao' AND livre_adesao_compulsorio = '$tipo_contratacao' AND descricao_do_plano = '$tipo_plano'";
